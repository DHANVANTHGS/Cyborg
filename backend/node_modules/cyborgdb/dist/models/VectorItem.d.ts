 ...
 */
export declare function instanceOfVectorItem(value: object): value is VectorItem;
export declare function VectorItemFromJSON(json: any): VectorItem;
export declare function VectorItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): VectorItem;
export declare function VectorItemToJSON(json: any): VectorItem;
export declare function VectorItemToJSONTyped(value?: VectorItem | null, ignoreDiscriminator?: boolean): any;
